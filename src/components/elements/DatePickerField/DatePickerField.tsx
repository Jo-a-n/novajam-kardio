...
export function DatePickerField({
  ...
  return (
    <DatePicker
      className="w-full border border-neutral-200 rounded-theme-button px-4 py-3.5 cursor-pointer focus:outline-none focus:shadow-lg text-inherit placeholder:text-neutral-400"
      placeholderText={
