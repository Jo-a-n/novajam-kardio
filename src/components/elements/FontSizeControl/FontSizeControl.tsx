  ...
  return (
    <>
      ...
      <button
        ...
        className="w-9 h-9 p-0.5 text-xl flex justify-center items-center rounded-full bg-blue-50/5 hover:bg-blue-950/80 dark:hover:bg-red-950/25 dark:text-neutral-100 transition duration-300"
      >
        <MdTextIncrease />
      </button>
      <button
